...
I'm Laurent Christophe, a consultant at the Vrije Universiteit Brussel (VUB). I'm an enthusiastic programmer and an active contributor to open-source projects. My expertise includes JavaScript/TypeScript, SQL, functional programming, distributed systems, CI/CD, and cloud deployment
...
& \quad Stack: Express, PostgreSQL, GitLab, CircleCI, AWS \\[0pt]
\end{tabularx}
\EndSubRubric{}
...
\Bullet & Offered position \\[\ItemSkip]
\end{tabularx}
\EndSubRubric{}
