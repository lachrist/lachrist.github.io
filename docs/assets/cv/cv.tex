...
I'm an enthusiastic programmer and active contributor to open-source projects. My expertise includes implementation of programming languages, functional programming, distributed systems, and, more recently, generative AI.
...
\begin{tabularx}{\linewidth}{@{}l@{}l@{}}
\Bullet & Advising companies for adopting generative AI \\[\ItemSkip]
\Bullet & Developed multiple proof-of-concept systems: \\[\SubItemSkip]
& \quad Semantic search for matching tenders against CPV codes \\[\SubItemSkip]
& \quad Pipeline for parsing PDF with generative AI \\[\ItemSkip]
\end{tabularx}
\EndSubRubric{}
...
& \quad Collectif Santé 1140: website built with Wordpress \\[\ItemSkip]
\end{tabularx}
\EndSubRubric{}
