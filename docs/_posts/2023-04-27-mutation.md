...
The amount of values that a function can reach and mutate is enormous. That is because the object graph is super connected. Think of the famous "gorilla and banana" problem.
