...
- [Structure and Interpretation of Computer Programs](https://web.mit.edu/6.001/6.037/sicp.pdf) This is a classic, and for good reason. It’s an excellent introduction to the implementation of managed languages, providing a deep understanding of the execution models of languages such as JavaScript, Python, and Haskell.
